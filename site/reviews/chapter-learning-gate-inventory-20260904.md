...
- acceptance_tests結果行: 699件（構造契約検査済み 261件、構造契約failed 0件、domain/learner実行済み 0件、not_run 438件）
...
- manifest acceptance_tests have 261 structural-contract rows verified; 0 structural rows failed and 438 domain/learner rows remain not_run
