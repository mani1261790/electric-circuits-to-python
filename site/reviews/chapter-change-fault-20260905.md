...
| 101 | GIL・free-threading | pass | pass | pass | false |
| 102 | inline cache・adaptive tier | pass | pass | pass | false |
| 103 | MiniPy compiler pipeline | pass | pass | pass | false |
| 104 | MiniPy RISC-V runtime | pass | pass | pass | false |
| 105 | cross-layer trace atlas | pass | pass | pass | false |
| 106 | modern-PC final mapping | pass | pass | pass | false |
...
第101章はGIL/free-threadingのCPU parallelismとinterpreter stateを扱い、I/O fractionの範囲外を拒否した。第102章はinline cache hit、guard failure、tier選択を扱い、未知tierを拒否した。第103章はMiniPy grammar/symbol pass/bytecodeを扱い、symbol pass失敗を拒否した。第104章はfreestanding runtimeのstack alignmentとUART/timer shimを扱い、未整列stackを拒否した。第105章はtrace ID・layer join・waveform coverageを扱い、空trace IDを拒否した。第106章はISA/cache/GPU/IOMMU/secure bootの現代PC写像を扱い、106層を超えるcoverage指定を拒否した。
